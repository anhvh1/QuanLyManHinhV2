...
import actions from '../../../redux/DanhMuc/DMChiTieu/actions';
...
import actionsLoaiMauPhieu from '../../../redux/DanhMuc/DMLoaiMauPhieu/actions';
...
const DMChiTieu = (props) => {
  ...
  const { DanhSachAllLoaiMauPhieu } = useSelector(
    (state) => state.DMLoaiMauPhieu,
  );
  ...
  useEffect(() => {
    ...
    danhSachCacCap();
    dispatch(actionsLoaiMauPhieu.getAll());
  ...
  return (
    <LayoutWrapper>
      ...
      <ModalEdit
        ...
        DanhSachAllLoaiMauPhieu={DanhSachAllLoaiMauPhieu}
        action={action}
      />
      <ModalAddEditMedia
