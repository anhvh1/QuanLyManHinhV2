const actions = {
  ...
  SOLIEUCANHBAO_GET_LIST: 'SOLIEUCANHBAO_GET_LIST',
  SOLIEUCANHBAO_GET_LIST_SUCCESS: 'SOLIEUCANHBAO_GET_LIST_SUCCESS',
  SOLIEUCANHBAO_GET_LIST_ERROR: 'DASHBOARD_GET_LIST_ERROR',

  getSoLieuCanhBao: (filterData) => ({
    type: actions.SOLIEUCANHBAO_GET_LIST,
    payload: {filterData},
  }),
};
